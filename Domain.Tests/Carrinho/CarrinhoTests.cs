...
namespace Domain.Tests.Carrinho
{
    ...
    public class CarrinhoTestClass
    {
        ...
        /// </summary>
        [TestMethod]
        public void TotalizarQuantidadeDeProdutoPorTipoDeProduto_DeveIdentificar1ProdutoComQuantidade3()
        {
            try
            {
                using (var provider = service.BuildServiceProvider())
                {
                    ...
                    var listaProdutosCarrinho = carrinhoService.ObterProdutosCarrinho();
